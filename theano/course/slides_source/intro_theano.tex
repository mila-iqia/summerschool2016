...
\begin{frame}[fragile]{Thanks for your attention}
  ...
  \uncover<2->{%
    \url{http://github.com/mila-udem/summerschool2016/}
    \begin{itemize}
      \item Slides: {\tt theano/course/intro\_theano.pdf}
      \item Notebook with the code examples: {\tt theano/course/intro\_theano.ipynb}
    \end{itemize}
  }
  ...
  \uncover<3->{%
    More resources
    \begin{itemize}
      \item Documentation: \url{http://deeplearning.net/software/theano/}
      \item Code: \url{http://github.com/Theano/Theano/}
      \item Article: The Theano Development Team, ``Theano: A Python framework for fast computation of mathematical expressions'', \url{https://arxiv.org/abs/1605.02688}
    \end{itemize}
  }
\end{frame}
...
\begin{frame}[fragile]{Exercises}
  ...
  \url{http://github.com/lamblin/ccw_tutorial/}
...
ipython notebook ccw_tutorial
      \end{minted}
    \item Navigate to {\tt Theano\_A2015}, then {\tt exercises.ipynb}
  \end{itemize}
\end{frame}
\end{document}
